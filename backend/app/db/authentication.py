...
def reg_auth(email_input, password_input, name_input, mobile_input, role,dob,gender,category):
    inserted_id = insert_data(email_input, password_input, mobile_input, name_input, role,dob,gender,category)
    print(inserted_id)
    if inserted_id:
